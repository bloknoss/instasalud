...
function Especialidades() {
    const Especialidades = [
        ...
        },
        {
            ...
            descripcion:
                "La cardiología es la rama de la medicina que se encarga del estudio, prevención, diagnóstico y tratamiento de las enfermedades del corazón y del sistema circulatorio. Es médica, pero no quirúrgica; los especialistas en  quirúrgico ",
        ...
        },
        {
            ...
            descripcion:
                "La Psicología es la ciencia que estudia el comportamiento y los procesos mentales. Los psicólogos aplican sus conocimientos para ayudar a las personas a comprender, explicar y cambiar su comportamiento.sus conocimientos para ayudar a las personas a ",
        ...
        <>
            <Container className="mt-5">
                ...
                <p className="font-weight-lighter">
                    Aquí podrás observar las distintas especialidades que disponemos. <br /> Garantizamos un servicio excelente en
                    cualquiera de las ramas de la medicina que usted desee.
                </p>
